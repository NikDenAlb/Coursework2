...
@Service
@Qualifier("thirdQuestionService")
public class ThirdQuestionService implements QuestionService {
    private final QuestionRepository javaQuestionRepository;

    public ThirdQuestionService(@Qualifier("thirdQuestionRepository")QuestionRepository javaQuestionRepository) {
